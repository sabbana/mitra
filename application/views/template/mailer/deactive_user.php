                        ...
                        <td class="content-wrap">
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
									<?php if($status == 1){?>
										<p>We have sorry to inform you that your account has been <b>deactivated</b> from Studio HUB. Now you are no longer able to log into the studio hub. Thank you for your attention </p>
									<?php }else{?>
										<p>We have to inform you that your account has been <b>activated</b> from Studio HUB. Now you are able to log into the studio hub. Thank you for your attention </p>
									<?php } ?>
                                    </td>
                                </tr>
